@ValidateOTP @ValidateOTPNETBANKING
Feature: RBL NetBanking Validate otp Feature File
  ...
  @Resource_Name_Vinayak @NetBanking_API_VOTP01_TC001
  Scenario: NetBanking_API_VOTP01_TC001
  ...
  @Resource_Name_Vinayak @NetBanking_API_VOTP02_TC002
  Scenario: NetBanking_API_VOTP02_TC002
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
  ...
  @Resource_Name_Vinayak @NetBanking_API_VOTP08_TC018
  Scenario: NetBanking_API_VOTP08_TC018
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
  ...
  @Resource_Name_Vinayak @NetBanking_API_VOTP08_TC019
  Scenario: NetBanking_API_VOTP08_TC019
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
  ...
  @Resource_Name_Vinayak @NetBanking_API_VOTP02_TC004
  Scenario: NetBanking_API_VOTP02_TC004
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
