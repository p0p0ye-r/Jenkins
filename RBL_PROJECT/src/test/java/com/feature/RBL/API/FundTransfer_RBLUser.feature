@GenerateOTPWithInUSER @GenerateOTP
Feature: RBL RBLUser Feature File
  ...
  Background: 
   ...
   @RBL_API_GOTP01_TC001 @Resource_Name_Vinayak
  Scenario: RBL_API_GOTP01_TC001
 ...
 #Check that OTP messages are getting generated as per the RBL template for combinations of delivery flag  S and ServiceType flags  S
  @RBL_API_GOTP02_TC003 @Resource_Name_Vinayak
  Scenario: RBL_API_GOTP02_TC003
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
    ...
    @Resource_Name_Vinayak @RBL_API_GOTP11_TC046
    Scenario: RBL_API_GOTP11_TC046
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
    ...
    @Resource_Name_Vinayak @RBL_API_GOTP11_TC047
     Scenario: RBL_API_GOTP11_TC047
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
    ...
    @RBL_API_GOTP12_TC055 @Resource_Name_Vinayak
    Scenario: RBL_API_GOTP12_TC055
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
   ...
   @Resource_Name_Vinayak @RBL_API_GOTP02_TC005 @BS
  Scenario: RBL_API_GOTP02_TC005
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
    ...
    @Resource_Name_Vinayak @TC_SC02_IMPS_3 @BV
  Scenario: RBL_API_GOTP02_TC006
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
  ...
  @Resource_Name_Vinayak @RBL_API_GOTP04_TC020
  Scenario: RBL_API_GOTP04_TC020
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
