...
Feature: RBL IMPS Feature File
  ...
  @TestmanagementID=T690 @Positive @Resource_Name_Vikash @Priority=High @Ram
  Scenario: IMPS_API_GOTP01_TC001
  ...
  @IMPS_API_GOTP02_TC003 @Resource_Name_Vinayak  @Positive
  Scenario: IMPS_API_GOTP02_TC003
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
  ...
  @Resource_Name_Vinayak @IMPS_API_GOTP02_TC005 @Positive
  Scenario: IMPS_API_GOTP02_TC005
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
  ...
  @Resource_Name_Vinayak @IMPS_API_GOTP11_TC046 @Negative
  Scenario: IMPS_API_GOTP11_TC046
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
  ...
  @Resource_Name_Vinayak @IMPS_API_GOTP11_TC047 @Negative
  Scenario: IMPS_API_GOTP11_TC047
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
  ...
  @IMPS_API_GOTP12_TC055 @Resource_Name_Vinayak @Negative
  Scenario: IMPS_API_GOTP12_TC055
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
  ...
  #@Resource_Name_Vinayak @IMPS_API_GOTP02_TC006 @BSASD
  #Scenario: IMPS_API_GOTP02_TC006
    #Given Load TestData Form Specific Api sheet "GET TOKEN"
    #Then Create Input File for Get OTP json from Excel Sheet
    #Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    #Then Save Final Response in "GetOtpJsonResponse.json" output File.
...
#Check that OTP messages are getting generated as per the RBL template for combinations of delivery flag  B and ServiceType flags  V
  @Resource_Name_Vinayak @IMPS_API_GOTP02_TC006 @Positive
  Scenario: IMPS_API_GOTP02_TC006
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
  ...
  @Resource_Name_Vinayak @IMPS_API_GOTP04_TC020
  Scenario: IMPS_API_GOTP04_TC020
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
