@ValidateOTP @ValidateOTPRTGS
Feature: RBL RTGS Validate otp Feature File
  ...
  Background: 
   ...
   @Resource_Name_Vinayak @RTGS_API_VOTP01_TC001
  Scenario: RTGS_API_VOTP01_TC001
    ...
    @Resource_Name_Vinayak @RTGS_API_VOTP02_TC002 
  Scenario: RTGS_API_VOTP02_TC002
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
    ...
    @Resource_Name_Vinayak @RTGS_API_VOTP08_TC018 
  Scenario: RTGS_API_VOTP08_TC018
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
    ...
    @Resource_Name_Vinayak @RTGS_API_VOTP08_TC019 
  Scenario: RTGS_API_VOTP08_TC019
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
    ...
    @Resource_Name_Vinayak @RTGS_API_VOTP02_TC004 
  Scenario: RTGS_API_VOTP02_TC004
    Given Load TestData Form Specific Api sheet "GET TOKEN"
    Then Create Input File for Get OTP json from Excel Sheet
    Then I go to "/api/v1/OAUTH/get-token" and "Post" Api Request Saved in Json File "GetOtpJsonTestData.json"without charset
    Then Save Final Response in "GetOtpJsonResponse.json" output File.
